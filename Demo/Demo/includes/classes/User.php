...
class User {
	...
	public function getUserData($id) {
		$array = array();
		$query = mysqli_query($this->con, "SELECT * FROM user WHERE id='$id'");
		while($row = mysqli_fetch_array($query)) {
			...
			$array['profileext'] = $row['profileext'];
	...
	function public getId($username) {
		$query = mysqli_query($this->con, "SELECT id FROM user WHERE username='$username'");
		while($row = mysqli_fetch_array($query)) {
			return $row['id'];
		}
